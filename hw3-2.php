...
$wishes = ["здоровья", "удачи", "любви", "везения", "мира", "добра", "улыбок", "благополучия", "счастья", "радости", "гармонии", "впечатлений", "успеха", "друзей", "спокойствия ", "настроения", "достатка"];
...
$name = readline("Введите имя имениника" . PHP_EOL);
